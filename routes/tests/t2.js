...
router.post('/register',async(req,res)=>{
   name_id1="", address_id1="", contact_id1="";
    ...
    try{
        ...
        await pool.query("INSERT INTO address_info set ?" ,address_data,(error, results, fields)=>
        {
        ...
        await pool.query("INSERT INTO contact_info set ?" ,contact_data,(error, results, fields)=>
        {
        ...
        await pool.query("INSERT INTO user set ?" ,user_data,(error, results, fields)=>
        {
